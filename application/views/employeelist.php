...
<body>
    ...
    <div id="container">
      <div class="Back">
        <button onclick="window.location.href='<?php echo base_url();?>Welcome/employeeregister'" style="text-align: right;" type="button" class="btn btn-success">Register Employee </button>
  </div>
